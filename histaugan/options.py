...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument(
            '--model_save_freq', type=int, default=1, help='freq (epoch) of saving models')
        self.parser.add_argument(
        ...
        self.parser.add_argument('--save_path', type=str, default='/data/new_weights', help='save path of results')
